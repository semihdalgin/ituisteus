...
public class CompareActivity extends Activity implements SensorEventListener, LocationListener
{
    ...
    private class MetarAsyncTask extends AsyncTask<Number, Void, Float>
    {
        private static final String WS_URL =
        		"http://api.openweathermap.org/data/2.5/weather?q=Antalya,tr";
        ...
        protected void onPostExecute(Float result)
        {
            ...
            {
                Toast.makeText(CompareActivity.this,R.string.webServiceConnectionFailureMessage,Toast.LENGTH_LONG).show();

                lastErrorMessageTimestamp = uptime;
            }
            else
            {
                CompareActivity.this.mslp = result;
            }

            CompareActivity.this.webServiceFetching = false;
        }
    }
}
